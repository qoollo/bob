...
pub(crate) mod prelude {
    ...
    pub use pearl::{
        filter::Config as BloomConfig, rio, Builder, Error as PearlError, ErrorKind as PearlErrorKind,
    ...
    pub use std::{
        ...
        fs::Metadata,
        io::{Result as IOResult, Error as IOError, ErrorKind as IOErrorKind},
        path::{Path, PathBuf},
        sync::Arc,
