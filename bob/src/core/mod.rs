...
mod prelude {
    ...
    pub(crate) use crate::metrics::{
        ContainerBuilder as MetricsContainerBuilder, ALIEN_BLOBS_COUNT, AVAILABLE_NODES_COUNT,
        BACKEND_STATE, BLOBS_COUNT, CLIENT_EXIST_COUNTER, CLIENT_EXIST_ERROR_COUNT_COUNTER,
        CLIENT_EXIST_TIMER, CLIENT_GET_COUNTER, CLIENT_GET_ERROR_COUNT_COUNTER, CLIENT_GET_TIMER,
        CLIENT_PUT_COUNTER, CLIENT_PUT_ERROR_COUNT_COUNTER, CLIENT_PUT_TIMER,
        GRINDER_EXIST_COUNTER, GRINDER_EXIST_ERROR_COUNT_COUNTER, GRINDER_EXIST_TIMER,
        GRINDER_GET_COUNTER, GRINDER_GET_ERROR_COUNT_COUNTER, GRINDER_GET_TIMER,
        GRINDER_PUT_COUNTER, GRINDER_PUT_ERROR_COUNT_COUNTER, GRINDER_PUT_TIMER, INDEX_MEMORY,
    };
