...
mod prelude {
    ...
    pub(crate) use crate::metrics::{
        ...
        ACTIVE_DISKS_COUNT, ALIEN_BLOBS_COUNT, AVAILABLE_NODES_COUNT, BACKEND_STATE, BLOBS_COUNT,
        CLIENT_EXIST_COUNTER, CLIENT_EXIST_ERROR_COUNT_COUNTER, CLIENT_EXIST_TIMER,
        CLIENT_GET_COUNTER, CLIENT_GET_ERROR_COUNT_COUNTER, CLIENT_GET_TIMER, CLIENT_PUT_COUNTER,
        CLIENT_PUT_ERROR_COUNT_COUNTER, CLIENT_PUT_TIMER, DISKS_FOLDER, GRINDER_EXIST_COUNTER,
